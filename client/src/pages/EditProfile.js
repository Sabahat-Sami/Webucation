    ...
    <div>
        <br/>
            <div onClick={handleImageClick} className=''>
                ...
                <img  src={pfp}
                      className='float-right mb-8 z-0 rounded-full w-[25%] mr-[20%] outline outline-offset-2 outline-4 outline-gray-400 hover:cursor-pointer hover:opacity-75 hover:scale-110 '/>
                <input
